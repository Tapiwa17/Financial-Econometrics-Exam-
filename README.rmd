...
This submission contains my answers for the 2025 Financial Econometrics practical. The structure follows the required format, with all data placed in the `/data/` folder, and one subfolder for each question under `/Questions/`. Below I walk through my process and thinking for each question.
...
holdrets <- read_rds("Questions/Question 3/Data/Hold_Rets_Sectors.rds")
port_holds <- read_rds("Questions/Question 3/Data/Fund_Holds.rds")
